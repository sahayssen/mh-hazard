...
<div class="map-box" style="border: 4px solid black; padding: 1rem;background-color:#ffffff;"> 
<h3><strong>Corporate Owned Manufactured Housing Communities Grouped By National Hazard Risk </strong></h3>
<br/>
<h4> This map shows the location of manufactured housing communities owned by private equity firms and coded by their county's composite national hazard risk rating. The rating, designated by FEMA, indicates how likely an area is to be affected by a natural hazard (i.e. tornadoes, avalances, extreme weather, etc.).</h4>
