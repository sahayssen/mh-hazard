...
<h3><strong>Private Equity Owned Manufactured Housing Communities Sorted By FEMA's National Hazard Risk Index </strong></h3>
<h4>It's increasingly common for manufactured housing communities to be owned by private equity firms, who are responsible for community infrastructure. This map shows the location of these communities, their owners, and their county's composite national hazard risk rating. The rating, designated by FEMA, indicates how likely the area is to be affected by a natural hazard (i.e. floods, tornadoes, avalances, extreme weather, etc.). Explore the map and click on a dot to learn more about the community.</h4>
